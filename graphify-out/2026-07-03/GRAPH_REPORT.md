# Graph Report - Bar Survivor  (2026-07-03)

## Corpus Check
- 24 files · ~27,065 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 267 nodes · 608 edges · 20 communities (11 shown, 9 thin omitted)
...
Cohesion: 0.10
Nodes (29): embaucher(), joursOuverture(), licencier(), planifierEvenements(), refuserCandidat(), refuserCV(), tirerEvenement(), toggleRepos() (+21 more)
...
Cohesion: 0.18
Nodes (10): appliquerAmelioration(), BONUS_PAR_NIVEAU, COUT_REPARATION, facteurUsure(), POIDS_MACHINE, PRIX_AMELIORATION, rendementMachine(), userMachines() (+2 more)
...
Cohesion: 0.15
Nodes (28): aIngenieur(), ameliorationsDebloquees(), ameliorerMachine(), capaciteBar(), coutLicenciement(), coutMenagePro(), coutTravaux(), DETTE_TOTALE (+20 more)

### Community 9 - "Community 9"
Cohesion: 0.17
Nodes (19): CATEGORIES_STOCK, agrandirBar(), aidesPourChoix(), bonusChanceux(), capaciteLocale(), efficaciteActuelle(), probaAvecAide(), trait() (+11 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (44): actifsN(), moyenne(), run(), RunResult, genererCandidats(), stocksPleins(), actifs(), AFFLUENCE_JOUR (+36 more)
...
- **Why does `#app (point de montage)` connect `UI & ecrans (rendu)` to `Community 0`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ecranMenu()` connect `Community 8` to `Community 0`?**
